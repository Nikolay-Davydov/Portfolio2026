...
4. Структура проекта (создаваемые каталоги и файлы) — выполнено
...
10. Резюме (PDF) — выполнено

- Положить PDF в public/resume.pdf. (Добавлено заглушечное resume.pdf)
- В Header и в app/resume/page.tsx добавлена ссылка для скачивания.

11. Оптимизация изображений — выполнено

- Плейсхолдеры загружены в `public/images/` и `components/ProjectCard.tsx` обновлён для использования изображений через `next/image`.

12. Линтинг и форматирование — выполнено
...
16. Проверки и валидация (acceptance criteria) — in-progress
...
17. Наполнение демонстрационным контентом (опционально, я могу подготовить) — выполнено
...
18. Документация и plan.md в проекте — выполнено
